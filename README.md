...
cell-type–specific subclustering and machine learning–based representations.
...
level, hepatocytes are subclustered in a cell-type–specific manner.
...
## 🤖 Machine learning & latent space modeling (scVI)
